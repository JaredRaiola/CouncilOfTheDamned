...
2. For each affected behavior area, provide at least ${floor.perWorkflow} DISTINCT test cases: different inputs, edge values, error paths. Proven = you ran the case GREEN and paste that case's assertion output line in \`proof\`. Described-but-not-run does not count.
